...
DEFAULTS = {
    ...
    "partial_tp1_pct": 50,           # share of the position closed at target 1; the stop then moves to breakeven
...
LIMITS = {
    ...
    "tp1_atr": (0.5, 5.0), "tp2_atr": (1.0, 10.0), "partial_tp1_pct": (0, 100), "vol_min": (0.5, 5.0), "high_vol_ratio": (1.2, 5.0),
